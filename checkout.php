					...
					<div class="returning-customer">
						...
						<form class="form-inline">
							<div class="form-group mb-2">
							    <label>Email</label>
							    <input type="email" class="form-control" placeholder="Email Address" style="display: block;width: 100%">
							</div>
							<div class="form-group mx-sm-3 mb-2">
							    <label>Password</label>
							    <input type="password" class="form-control" placeholder="Password" style="display: block;width: 100%">
							</div>
							<button type="submit" class="btn login-btn mt-3 mb-2">sign in</button>
						</form>
					</div>
